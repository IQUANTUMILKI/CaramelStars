...
public class Ending : MonoBehaviour
{
    ...
    public void open()
    {
        ...
        if (MainLine.GetComponent<MainLine>().Camera.transform.parent.GetComponent<CameraFollower>())
        {
            MainLine.GetComponent<MainLine>().Camera.transform.parent.GetComponent<CameraFollower>().enabled = false;
        }
